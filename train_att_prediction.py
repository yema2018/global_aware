...
class ParallelLoss(nn.Module):
    ...
    def forward(self, inp, tar, inp_mask, tar_mask):
        ...
        # print(pre_att_dist[0, :20])
        # print(opt_att_dist[0, :20])
        # loss = 0
...
if __name__ == '__main__':
    ...
    a = TrainPreAtt(bart, tokenizer, 'layer_2_d_ml800_0', 1, 1, 2, 'cnndm')
    a.train()
